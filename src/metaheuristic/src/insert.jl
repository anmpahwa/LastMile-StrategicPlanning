...
"""
insert!(rng::AbstractRNG, s::Solution, method::Symbol)::Solution = isdefined(MetaHeuristic, method) ? getfield(MetaHeuristic, method)(rng, s) : getfield(Main, method)(rng, s)
